...
This document describes how nik works internally: the brain loop, sensors and reflexes, the messaging adapter model, autonomous systems, the task/timeline model, and built-in tools.

For installation and onboarding, see the [README](../README.md).
