...
SET
  ...
  cached_tokens = cached_tokens + ?10,
  reasoning_tokens = reasoning_tokens + ?11,
  cost_usd = cost_usd + ?12,
  round_count = MAX(round_count, ?13),
  max_input_tokens_per_round = MAX(max_input_tokens_per_round, ?14),
  max_total_tokens_per_round = MAX(max_total_tokens_per_round, ?15),
  tool_call_count = tool_call_count + ?16,
