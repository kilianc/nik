...
var modelPricing = map[string]tokenPricing{
	...
	"claude-opus-5":     {input: 5.0e-6, output: 25.0e-6, cached: 0.50e-6, contextWindow: 1_000_000},
	"claude-opus-4-8":   {input: 5.0e-6, output: 25.0e-6, cached: 0.50e-6, contextWindow: 1_000_000},
	"claude-opus-4-7":   {input: 5.0e-6, output: 25.0e-6, cached: 0.50e-6, contextWindow: 1_000_000},
	"claude-opus-4-6":   {input: 5.0e-6, output: 25.0e-6, cached: 0.50e-6, contextWindow: 1_000_000},
	"claude-sonnet-4-6": {input: 3.00e-6, output: 15.0e-6, cached: 0.30e-6, contextWindow: 1_000_000},
	"claude-haiku-4-5":  {input: 1.00e-6, output: 5.00e-6, cached: 0.10e-6, contextWindow: 200_000},
