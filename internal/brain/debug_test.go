...
func TestWriteDebugMarkdownProducesExpectedSections(t *testing.T) {
	...
	checks := []struct {
		...
		{"user input collapsed", "<details><summary>User Input</summary>"},
		{"user input body", "hello nik"},
		{"tools collapsed", "<details><summary>Tools</summary>"},
		{"tools body", "`message_reply`, `shell`"},
		{"tool calls collapsed", "<details><summary>Tool Calls</summary>"},
		{"tool call collapsed", "<details><summary>1. message_reply</summary>"},
		{"tool call error collapsed", "<details><summary>2. shell (error)</summary>"},
		{"tool call args json", `"message": "hey"`},
		{"tool call result json", `"sent": true`},
		{"tool call plain result", "file.txt\ndir/"},
		{"output collapsed", "<details><summary>Output</summary>"},
